...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 128, PSA_ALG_CTR,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000000,
...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 128, PSA_ALG_CBC_NO_PADDING,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000001,
...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 128, PSA_ALG_ECB_NO_PADDING,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000002,
...
static void el2go_blob_test_internal_1003(struct test_result_t *ret)
{
    psa_blob_aead_test(
        ...
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000003,
...
static void el2go_blob_test_internal_1004(struct test_result_t *ret)
{
    psa_blob_mac_test(
        ...
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000004,
...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 256, PSA_ALG_CTR,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000010,
...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 256, PSA_ALG_CBC_NO_PADDING,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000011,
...
{
    psa_blob_cipher_test(
        PSA_KEY_TYPE_AES, 256, PSA_ALG_ECB_NO_PADDING,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000012,
...
static void el2go_blob_test_internal_1013(struct test_result_t *ret)
{
    psa_blob_aead_test(
        ...
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000013,
...
{
    psa_blob_mac_test(
        PSA_KEY_TYPE_AES, 256, PSA_ALG_CMAC,
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000014,
...
static void el2go_blob_test_internal_1030(struct test_result_t *ret)
{
    psa_blob_mac_test(
        ...
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000030,
        INTERNAL_HMAC256_MAC_HMACSHA256, sizeof(INTERNAL_HMAC256_MAC_HMACSHA256), ret
    );
}
...
{
    psa_blob_kdf_test(
        PSA_KEY_TYPE_DERIVE, 256, PSA_ALG_HKDF(PSA_ALG_SHA_256),
        PSA_KEY_LOCATION_S50_BLOB_STORAGE, 0x3E000031,
        INTERNAL_HMAC256_KDF_HKDFSHA256, sizeof(INTERNAL_HMAC256_KDF_HKDFSHA256), ret
    );
}
...
static struct test_t blob_internal_tests[] = {
    {&el2go_blob_test_internal_1000, "EL2GO_BLOB_TEST_INTERNAL_1000",
     "Internal AES128 CIPHER CTR"},
    {&el2go_blob_test_internal_1001, "EL2GO_BLOB_TEST_INTERNAL_1001",
     "Internal AES128 CIPHER CBC"},
    {&el2go_blob_test_internal_1002, "EL2GO_BLOB_TEST_INTERNAL_1002",
     "Internal AES128 CIPHER ECB"},
    {&el2go_blob_test_internal_1003, "EL2GO_BLOB_TEST_INTERNAL_1003",
     "Internal AES128 AEAD GCM"},
    {&el2go_blob_test_internal_1004, "EL2GO_BLOB_TEST_INTERNAL_1004",
     "Internal AES128 MAC CMAC"},

    {&el2go_blob_test_internal_1010, "EL2GO_BLOB_TEST_INTERNAL_1010",
     "Internal AES256 CIPHER CTR"},
    {&el2go_blob_test_internal_1011, "EL2GO_BLOB_TEST_INTERNAL_1011",
     "Internal AES256 CIPHER CBC"},
    {&el2go_blob_test_internal_1012, "EL2GO_BLOB_TEST_INTERNAL_1012",
     "Internal AES256 CIPHER ECB"},
    {&el2go_blob_test_internal_1013, "EL2GO_BLOB_TEST_INTERNAL_1013",
     "Internal AES256 AEAD GCM"},
    {&el2go_blob_test_internal_1014, "EL2GO_BLOB_TEST_INTERNAL_1014",
    ...
    {&el2go_blob_test_internal_1031, "EL2GO_BLOB_TEST_INTERNAL_1031",
     "Internal HMAC256 KDF HKDFSHA256"},
};
