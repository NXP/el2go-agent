...
3.  [Optional] EdgeLock 2GO applications support two boot modes:
...
8.  Flash the application to the board: as explained in the section 3, in typical production use case the example is encrypted
